-- Include modified_movements in the live-state bootstrap.
--
-- Signed-in athletes receive the column through membership-scoped
-- postgres_changes, but guests and every first read come through this
-- function's explicit column list. Without it the Modified badge would appear
-- for some viewers of a mission and not others.
--
-- Function body is otherwise unchanged from 20260903160000.
