-- Carry rpe / session_notes / check_ins on the two read paths that already
-- carry movement_variants, so My missions and live state can show check-ins.
--
-- Both function bodies are otherwise unchanged from
-- 20260909160000_variants_on_read_paths.sql.
