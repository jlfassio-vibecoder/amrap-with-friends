-- One pinned announcement per room.
--
-- The plan is explicit that v1 has no chat, DMs or video: an announcement plus
-- reactions plus the mission itself is enough to test whether people come back.
-- So this is one row per room, replaced in place -- not a feed, not a history,
-- and nothing an athlete can post into.
