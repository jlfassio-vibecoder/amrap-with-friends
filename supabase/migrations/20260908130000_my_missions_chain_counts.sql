-- Surface planned chain length on My Missions so a lone mission-1 row still
-- reads as part of a multi-mission session (unstarted slots are not mission rows).
