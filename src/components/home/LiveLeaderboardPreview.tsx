        ...
        <div className="grid gap-3 sm:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
          ...
          <div className="card space-y-3 p-4">
            <div className="relative flex items-center justify-center">
              <p className="text-display text-sm text-ink lg:text-base">Leaderboard</p>
              <span className="absolute right-0 inline-flex items-center gap-1.5 rounded-full border border-border bg-page px-2.5 py-1 text-[11px] font-semibold text-success-text">
