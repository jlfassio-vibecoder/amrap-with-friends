...
describe('DomainMatrixChart', () => {
  it('shows empty copy and no warning when core volume is zero', () => {
    render(<DomainMatrixChart domainMinutes30d={{ 5: 0, 10: 0, 15: 0, 20: 0, other: 0 }} />);
  ...
  it('heads each column with the range it counts, not the canonical minute', () => {
    ...
    render(<DomainMatrixChart domainMinutes30d={{ 5: 10, 10: 10, 15: 10, 20: 10, other: 0 }} />);
  ...
  it('shows Marathon warning when sprint domain dominates', () => {
    render(<DomainMatrixChart domainMinutes30d={{ 5: 120, 10: 10, 15: 10, 20: 10, other: 0 }} />);
