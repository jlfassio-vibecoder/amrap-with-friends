...
export const EXERCISE_PATTERN_TAGS: Record<string, MovementPattern[]> = {
  ...
  'back-widow': ['upper-pull'],
  'w-press-ups': ['upper-pull'],
  't-press-ups': ['upper-pull'],
  'supine-floor-scapular-shrugs': ['upper-pull'],
  ...
  '90-90-hip-transitions': ['lower-body'],
  'spiderman-lunge-with-thoracic-reach': ['lower-body', 'core'],
  'downward-facing-dog-to-cobra': ['core', 'upper-push'],
  'quadruped-hip-circles': ['lower-body'],
  'low-lunge': ['lower-body'],
  'half-moon-pose': ['lower-body', 'core'],
  'prone-internal-rotation-windshield-wipers': ['lower-body'],
  'cobra-pose': ['core'],
  'childs-pose': ['core'],
  'cat-and-cow': ['core'],
  'downward-facing-dog': ['upper-push', 'lower-body'],
  'camel-pose': ['core'],
  'pigeon-pose': ['lower-body'],
  '90-90-hip-internal-rotation-lift': ['lower-body'],
};
